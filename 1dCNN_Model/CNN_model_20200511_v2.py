...
LayerUnits = 128
path = '/data1/Yan-Cheng-Hsu/CNNModel_20200505/CNN_model_20200511_v2.h5'
...
X_CNN = Dropout(0.2)(X_CNN)
X_CNN = BatchNormalization()( X_CNN )
X_CNN = Conv1D( 256 , 3 , border_mode = 'same' , activation = 'relu' )( X_CNN )
X_CNN = Dropout(0.2)(X_CNN)
X_CNN = BatchNormalization()( X_CNN )
X_CNN = Conv1D( 512 , 3 , border_mode = 'same' , activation = 'relu' )( X_CNN )
X_CNN = Dropout(0.2)(X_CNN)
X_CNN = BatchNormalization()( X_CNN )


X0 = Bidirectional(GRU(LayerUnits, return_sequences=True , activation = 'relu' ), merge_mode='concat')(X_CNN)
X0 = Dropout(0.2)(X0)
X0 = Activation('relu')(X0)

X = Bidirectional( GRU( LayerUnits, return_sequences=True  , activation = 'relu' ) , merge_mode = 'concat' )(X0)
X = Dropout(0.2)(X)
X = Activation('relu')(X)
'''
...
GRUModel.fit(PPG_train, BP_train, validation_split = 0.1 , epochs = 50, batch_size = 32)
