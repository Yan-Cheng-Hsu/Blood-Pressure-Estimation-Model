...
#model1 start
Inputshape_ppg = ( len(PPG_train[0]) , len(PPG_train[0][0]) )
Inputshape_diff1 = ( len(DIFF1_train[0]) , len(DIFF1_train[0][0]) )
Inputshape_diff2 = ( len(DIFF2_train[0]) , len(DIFF2_train[0][0]) )
LayerUnits = 128
path = '/data1/Yan-Cheng-Hsu/CNNModel_20200505/CNN_model_20200512.h5'

PPG_input = Input( Inputshape_ppg )
PPG_CNN = Conv1D( 64 , 3 , border_mode = 'same' , activation = 'relu' )( PPG_input )
PPG_CNN = Dropout(0.2)(PPG_CNN)
PPG_CNN = BatchNormalization()( PPG_CNN )
PPG_CNN = Conv1D( 128 , 3 , border_mode = 'same' , activation = 'relu' )( PPG_CNN )
PPG_CNN = Dropout(0.2)(PPG_CNN)
PPG_CNN = BatchNormalization()( PPG_CNN )
PPG_CNN = Conv1D( 256 , 3 , border_mode = 'same' , activation = 'relu' )( PPG_CNN )
PPG_CNN = Dropout(0.2)(PPG_CNN)
PPG_CNN = BatchNormalization()( PPG_CNN )


DIFF1_input = Input( Inputshape_diff1 )
DIFF1_CNN = Conv1D( 64 , 3 , border_mode = 'same' , activation = 'relu' )( DIFF1_input )
DIFF1_CNN = Dropout(0.2)(DIFF1_CNN)
DIFF1_CNN = BatchNormalization()( DIFF1_CNN )
DIFF1_CNN = Conv1D( 128 , 3 , border_mode = 'same' , activation = 'relu' )( DIFF1_CNN )
DIFF1_CNN = Dropout(0.2)(DIFF1_CNN)
DIFF1_CNN = BatchNormalization()( DIFF1_CNN )
DIFF1_CNN = Conv1D( 256 , 3 , border_mode = 'same' , activation = 'relu' )( DIFF1_CNN )
DIFF1_CNN = Dropout(0.2)(DIFF1_CNN)
DIFF1_CNN = BatchNormalization()( DIFF1_CNN )

DIFF2_input = Input( Inputshape_diff2 )
DIFF2_CNN = Conv1D( 64 , 3 , border_mode = 'same' , activation = 'relu' )( DIFF2_input )
DIFF2_CNN = Dropout(0.2)(DIFF2_CNN)
DIFF2_CNN = BatchNormalization()( DIFF2_CNN )
DIFF2_CNN = Conv1D( 128 , 3 , border_mode = 'same' , activation = 'relu' )( DIFF2_CNN )
DIFF2_CNN = Dropout(0.2)(DIFF2_CNN)
DIFF2_CNN = BatchNormalization()( DIFF2_CNN )
DIFF2_CNN = Conv1D( 256 , 3 , border_mode = 'same' , activation = 'relu' )( DIFF2_CNN )
DIFF2_CNN = Dropout(0.2)(DIFF2_CNN)
DIFF2_CNN = BatchNormalization()( DIFF2_CNN )

X_CNN = concatenate( [ PPG_CNN , DIFF1_CNN , DIFF2_CNN ] )

X0 = Bidirectional(GRU(LayerUnits, return_sequences=True , activation = 'relu' , dropout = 0.2 ), merge_mode='concat')(X_CNN)
X0 = Bidirectional(GRU(LayerUnits, return_sequences=True , activation = 'relu' , dropout = 0.2 ), merge_mode='concat')(X0)
'''
